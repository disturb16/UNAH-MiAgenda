...
CREATE TABLE IF NOT EXISTS `miagnd_unah`.`tipo_usuario` (
  ...
  `descripcion` VARCHAR(45) NOT NULL,
  `tipo_estadoID` INT NOT NULL,
  `fechaCreo` DATETIME NOT NULL,
  `fechaElimino` DATETIME NULL,
  `usuarioElimino` INT NULL,
  PRIMARY KEY (`tipoUsuarioID`),
  INDEX `fkTPUsuarioEstado_idx` (`tipo_estadoID` ASC),
...
CREATE TABLE IF NOT EXISTS `miagnd_unah`.`usuarios` (
  ...
  `userName` VARCHAR(90) CHARACTER SET 'latin1' NOT NULL,
...
CREATE TABLE IF NOT EXISTS `miagnd_unah`.`cronogramaAcademico` (
  ...
  `tituloCronograma` VARCHAR(45) CHARACTER SET 'latin1' NOT NULL,
...
CREATE TABLE IF NOT EXISTS `miagnd_unah`.`asignaturas` (
  ...
  `codigoAsignatura` VARCHAR(45) CHARACTER SET 'latin1' NOT NULL,
  `tipoEstadoID` INT NOT NULL,
  `fechaCreo` DATETIME NOT NULL,
  `fechaElimino` DATETIME NULL,
  `usuarioElimino` INT NULL,
...
CREATE TABLE IF NOT EXISTS `miagnd_unah`.`publicaciones_asignatura` (
  ...
  `usuarioID` INT(11) NOT NULL,
  `tituloPublicacion` VARCHAR(100) CHARACTER SET 'latin1' NOT NULL,
  `contenidoPublicacion` LONGTEXT CHARACTER SET 'latin1' NOT NULL,
  `tipoEstadoID` INT NOT NULL,
  `fechaCreo` DATETIME NOT NULL,
  `fechaElimino` DATETIME NULL,
  `UsuarioElimino` INT NULL,
...
CREATE TABLE IF NOT EXISTS `miagnd_unah`.`eventos` (
  ...
  `usuarioID` INT(11) NOT NULL,
  `tituloEvento` VARCHAR(150) CHARACTER SET 'latin1' NOT NULL,
  `contenidoEvento` LONGTEXT CHARACTER SET 'latin1' NOT NULL,
  `descripcionNoticia` VARCHAR(200) CHARACTER SET 'latin1' NOT NULL,
  `imagenPortada` VARCHAR(200) CHARACTER SET 'latin1' NOT NULL,
  `descripcionImagenPortada` VARCHAR(200) CHARACTER SET 'latin1' NULL,
  `tipoEstadoID` INT NOT NULL,
  `fechaCreo` DATETIME NOT NULL,
  `fechaElimino` DATETIME NULL,
  `usuarioElimino` INT NULL,
...
CREATE TABLE IF NOT EXISTS `miagnd_unah`.`noticias` (
  ...
  `usuarioID` INT(11) NOT NULL,
  `tituloNoticia` VARCHAR(100) CHARACTER SET 'latin1' NOT NULL,
  `contenidoNoticia` LONGTEXT CHARACTER SET 'latin1' NOT NULL,
  `imagenPortada` VARCHAR(200) CHARACTER SET 'latin1' NOT NULL,
  `descripcionNoticia` VARCHAR(200) CHARACTER SET 'latin1' NOT NULL,
  `descripcionImagenPortada` VARCHAR(200) CHARACTER SET 'latin1' NULL,
  `tipoEstadoID` INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS `miagnd_unah`.`calificaciones` (
  ...
  `fechaElimino` DATETIME NULL,
  `usuarioElimino` INT NULL,
  PRIMARY KEY (`calificacionID`, `seccionID`, `usuarioID`, `parcial`),
...
-- -----------------------------------------------------
-- Table `miagnd_unah`.`seccion_parcial`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `miagnd_unah`.`seccion_parcial` (
  `seccionParcialID` INT NOT NULL AUTO_INCREMENT,
  ...
  `usuarioElimino` INT NULL,
  `tipoEstadoID` INT NOT NULL,
  PRIMARY KEY (`seccionParcialID`, `parcial`, `seccionID`),
  INDEX `fkParcialSeccion_idx` (`seccionID` ASC),
  INDEX `fkParcialUsuarioelimino_idx` (`usuarioElimino` ASC),
  INDEX `fkParcialEstado_idx` (`tipoEstadoID` ASC),
  CONSTRAINT `fkParcialSeccion`
    FOREIGN KEY (`seccionID`)
    REFERENCES `miagnd_unah`.`secciones` (`seccionID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fkParcialUsuarioelimino`
    FOREIGN KEY (`usuarioElimino`)
    REFERENCES `miagnd_unah`.`usuarios` (`usuarioID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
