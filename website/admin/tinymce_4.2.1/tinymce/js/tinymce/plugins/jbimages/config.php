...
| -------------------------------------------------------------------*/
	...
	$config['img_path'] = '/archivos/images_notis'; // Relative to domain name
	$config['upload_path'] = "/home/disturb16/public_html".$config['img_path']; // Physical path. [Usually works fine like this]
